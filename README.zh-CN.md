...
[![Version](https://img.shields.io/badge/version-0.4.6-blue?style=flat-square)](https://github.com/justhil/pi-app/releases/latest)
...
- **输入区** — 内联文件附件、粘贴图片、模型与思考等级切换、斜杠命令菜单
