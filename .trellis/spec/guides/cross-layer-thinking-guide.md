...
`prd.md` + `design.md` + `implement.md`, task-creation consent, and Agent 桌面
...
**Real-world example**: Agent 桌面 inline mode changed workflow platform markers from
`[Agent 桌面]` / `[Kilo, Antigravity, Windsurf]` to `[codex-sub-agent]` /
